          ...
          >
            ...
            {openProjections[index] && (
              <div className="w-full flex flex-row flex-wrap  items-center space-y-4">
                <div className="w-full md:w-1/2 flex flex-col  items-center space-y-4 space-x-0 md:space-x-4 ">
                  {/* Title For Description */}
                  <h2 className="text-2xl font-semibold m-4">Description</h2>
                  <p>{projection.description}</p>
                </div>

                <div className="w-full flex md:w-1/2  flex-col items-center space-y-4 space-x-0 md:space-x-4">
                  {/* Title For Map */}
